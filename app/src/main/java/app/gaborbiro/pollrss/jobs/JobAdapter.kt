...
class JobAdapter(private val jobs: MutableList<Job>, private val callback: JobAdapterCallback) :
    BaseJobAdapter<JobViewHolder>(jobs, R.layout.card_job) {

    interface JobAdapterCallback {
